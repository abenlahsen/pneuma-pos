...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traduction française des messages d'erreur par défaut du validateur.
    | APP_LOCALE et APP_FALLBACK_LOCALE valent "fr" en production (voir
    | deploy/deploy.sh), donc ce fichier doit couvrir toutes les clés
    | utilisées par le framework — sinon Laravel affiche la clé brute
    | (ex. "validation.unique") au lieu d'un message lisible.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Le champ :attribute donné a été exposé lors d\'une fuite de données. Veuillez choisir un autre :attribute.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Permet de remplacer le nom technique d'un champ par un libellé lisible
    | dans les messages ci-dessus (ex. "phone" -> "téléphone").
    |
    */
