...
export const routes: Routes = [
  ...
  },
  {
    path: 'dashboard',
    canActivate: [authGuard],
    // `flush` : l'accueil est une grille a deux colonnes qui gere sa propre
    // hauteur et son propre defilement ; la coquille ne lui met pas de marge.
    data: { shell: 'flush' },
    loadComponent: () =>
  ...
  },
  {
    ...
    data: { permission: 'view products' },
    loadComponent: () =>
      import('./features/products/pages/product-detail-page.component').then((m) => m.ProductDetailPageComponent),
  },
  {
    path: 'brands',
    canActivate: [authGuard, permissionGuard],
